...
namespace LogicaSmartWat
{
    public class PajaController
    {
                    ...
                    try
                    {
                        ...
                        foreach (var P in Ps)
                        {
                            ...
                            C.Add(new Cobros
                            {
                                ...
                                Factura = P.Factura,
                                EstadoCorreo = P.EstadoCorreo,
                                EstadoFE = EstadoHacienda(P.EstadoHacienda),
                                Detalle = (from L in Ts
                                           select new DetalleCobros
                                           {
        ...
        private string EstadoHacienda(int CodEstado)
        {
            switch (CodEstado)
            {
                case 0:
                ...
                case 1:
                    return "XML creado";
                    case 2:
                    return "Firmado Sin Enviar";
                case 3:
                    return "XML recibido SIN Confirmar";
                case 4:
                    return "RECHAZADO";
                case 5:
                    return "ACEPTADO";
                ...
                case 7:
                    return "procesando";
                case 8:
                    return "NC en Proceso";
                case 9:
                    return "NC Aplicada OK";
                default:
                    return "Desconocido";
            }
        }
